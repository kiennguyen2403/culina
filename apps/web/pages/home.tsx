...
import { GroupWithNotifications, DMChannel, Recipe } from "@/utils/types";
import { Spinner } from "ui/components/spinner";
import { BoxIcon, TrendingUpIcon } from "lucide-react";
        ...
        <>
            ...
            <div className="flex flex-row gap-3 mt-3">
                <Button 
                    color="primary"
                    onClick={() => {
                        router.push("/video/random")
                    }}
                >
                    Quick Join
                </Button>
                <Button onClick={() => setModal("create-group")}>
                    Create Group
                </Button>
            ...
            {dmQuery.isLoading || groups.isLoading ? (
                ...
                <>
                    ...
                    <h1 className="text-lg font-semibold mt-6 mb-2">Recipe lists</h1>
                    <RecipeMenu />
                </>
            )}
        </>
